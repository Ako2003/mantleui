...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="rounded-md p-1.5 text-slate-500 dark:text-white transition-colors hover:bg-slate-100 hover:text-slate-900 dark:hover:bg-zinc-800 dark:hover:text-white"
