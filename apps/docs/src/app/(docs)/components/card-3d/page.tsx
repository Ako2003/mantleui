      ...
      <div className="mt-4 flex flex-wrap gap-6">
        ...
        >
          <div style={{ width: 260, padding: 16 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              {["Everything in Pro", "SSO & SAML", "Dedicated support"].map(
                (f) => (
                  <div
                    key={f}
                    style={{
        ...
        <FlipCard
          ...
          front={
            ...
            >
              ...
              <p
                style={{ margin: "8px 0 0", fontSize: 11, color: "#6366f180" }}
              >
        ...
        <FlipCard
          ...
          front={
            ...
            >
              ...
              <p
                style={{ margin: "10px 0 0", fontSize: 11, color: "#22c55e50" }}
              >
                Click for vertical flip
              </p>
            </div>
          }
          back={
            ...
            >
              ...
              <p
                style={{ margin: "8px 0 0", fontSize: 11, color: "#22c55e50" }}
              >
                Click to flip back
              </p>
            </div>
